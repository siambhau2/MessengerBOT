...
var id = event.senderID;
 ...
 if (event.body.indexOf("SIAM")==0 || (event.body.indexOf("Siam Bhai")==0) || event.body.indexOf("সিয়াম ভাই")==0 ||
event.body.indexOf("Siam")==0 ||
event.body.indexOf("Siam Bro")==0 ||
event.body.indexOf("সিয়াম")==0 ||
event.body.indexOf("Siam")==0 ||
event.body.indexOf("Siam")==0 ||
event.body.indexOf("Siam")==0 ||
event.body.indexOf("Siam")==0) {
